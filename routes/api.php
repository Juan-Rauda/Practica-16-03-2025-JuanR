...
use App\Http\Controllers\Api\{
    CreatePermissionRolController,
    MntPedidosController,
    CtlCategoriaController,
    CtlProductosController,
    ClienteController
};
...
// Agrupación de rutas de autenticación
...
Route::prefix('catalogo')->group(function () {
    ...
    Route::get('/productos', [CtlProductosController::class, 'index']); // Lista de productos
